...
// 中国城市数据（按省份分组）
export const CITIES: Record<string, Array<{ code: string; name: string }>> = {
  '110000': [
  ...
  '710000': [
    ...
    { code: '710002', name: '高雄市' },
    { code: '710003', name: '台南市' },
    { code: '710004', name: '台中市' },
    { code: '710005', name: '金门市' },
    { code: '710006', name: '连江县' },
    { code: '710007', name: '南投县' },
    { code: '710008', name: '基隆市' },
    { code: '710009', name: '新竹市' },
    { code: '710010', name: '嘉义市' },
    { code: '710011', name: '新北市' },
    { code: '710012', name: '宜兰县' },
    { code: '710013', name: '新竹县' },
    { code: '710014', name: '桃园市' },
    { code: '710015', name: '苗栗县' },
    { code: '710016', name: '彰化县' },
    { code: '710017', name: '云林县' },
    { code: '710018', name: '嘉义县' },
    { code: '710019', name: '屏东县' },
    { code: '710020', name: '澎湖县' },
    { code: '710021', name: '花莲县' },
    { code: '710022', name: '台东县' },
  ],
  '810000': [
    { code: '810001', name: '中西区' },
    { code: '810002', name: '东区' },
    { code: '810003', name: '南区' },
    { code: '810004', name: '湾仔区' },
    { code: '810005', name: '九龙城区' },
    { code: '810006', name: '观塘区' },
    { code: '810007', name: '深水埗区' },
    { code: '810008', name: '黄大仙区' },
    { code: '810009', name: '油尖旺区' },
    { code: '810010', name: '沙田区' },
    { code: '810011', name: '大埔区' },
    { code: '810012', name: '葵青区' },
    { code: '810013', name: '北区' },
    { code: '810014', name: '西贡区' },
    { code: '810015', name: '屯门区' },
    { code: '810016', name: '荃湾区' },
    { code: '810017', name: '元朗区' },
    { code: '810018', name: '离岛区' },
  ],
  '820000': [
    { code: '820001', name: '花地玛堂区' },
    { code: '820002', name: '圣安多尼堂区' },
    { code: '820003', name: '大堂区' },
    { code: '820004', name: '望德堂区' },
    { code: '820005', name: '风顺堂区' },
    { code: '820006', name: '嘉模堂区' },
    { code: '820007', name: '圣方济各堂区' },
  ],
}
